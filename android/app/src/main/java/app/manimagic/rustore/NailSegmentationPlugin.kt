...
class NailSegmentationPlugin : Plugin() {
    ...
    companion object {
        ...
        //
        // С 9 сентября 2026 здесь 640, хотя веса обучены при 512. Замер по
        // экзаменам: те же веса под входом 640 находят на контрольных снимках
        // 124 ногтя из 133 против 115, на подборке 21 из 32 против 12. Сеть
        // свёрточная, ей можно подать вход другого размера, и на реальных
        // телефонных кадрах, где ноготь мелкий, это заметно помогает. Цена —
        // макро-кадры: там ноготь и так крупный, и на снимках без лака стало
        // 53 из 59 вместо 58.
